...
do
    python lira-train-org-dmp.py  --train_dmp 1 --train_org 0 --distill_lr 1.0 --train_lr 0.0005  \
           --save_tag $tag --total_models $total_models --train_size $train_size \
            --folder_tag $folder_tag --gpu $gpu  --res_folder $res_folder --num_synt_sample 100000
