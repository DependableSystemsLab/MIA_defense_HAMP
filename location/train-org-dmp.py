...
parser.add_argument('--org_path', type=str, default=None, help='path to the undefened model, used for knowledge distillation')
parser.add_argument('--synt_data_path', type=str, default=None, help='path to the synthetic data')
parser.add_argument('--num_synt_for_train', type=int, default=10000)
