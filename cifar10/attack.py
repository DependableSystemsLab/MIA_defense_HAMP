...
best_model=densenet(num_classes=num_classes,depth=100,growthRate=12,compressionRate=2,dropRate=0)
...
if(args.attack == 'entropy'):
    ...
    def loss_threshold_attack(model, shadow_model, x_, y_true, shadow_x, shadow_y, non_Mem_Generator, num_classes=10):
