...
best_model=densenet(num_classes=10,depth=100,growthRate=12,compressionRate=2,dropRate=0)
criterion=nn.CrossEntropyLoss()
use_cuda = True
...
print('\t===> AdvReg model %s | train acc %.4f | val acc %.4f | test acc %.4f'%(resume_best, best_train, best_val, best_test), flush=True)
