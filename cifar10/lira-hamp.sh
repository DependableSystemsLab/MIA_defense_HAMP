...
do
    python lira-train-hamp.py  --isTrain 1 --train_size $train_size --entropy_percentile 0.95 \
            --entropy_penalty 1 --alpha 0.001  --distill_lr 0.5 \
    ...
    --save_tag $tag --train_size $train_size  --res_folder $res_folder --isModifyOutput 1 --gpu $gpu
done
...
python lira-inference-defense.py --org_path ./final-all-models/$defense-trainSize-$train_size.pth.tar \
     --train_size $train_size  --res_folder lira-$folder_tag-defense-fullMember-$train_size  --isModifyOutput 1
