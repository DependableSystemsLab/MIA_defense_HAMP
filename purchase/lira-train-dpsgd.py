...
parser.add_argument('--folder_tag', type=str, default='dpsgd')
parser.add_argument('--res_folder', type=str, default='lira-dpsgd-fullMember')
...
# use a different set of val data as the original val data was used as the shadow set of training shadow models
...
print('\t===> Shadow DPSGD %s | train acc %.4f | val acc %.4f | test acc %.4f'%(resume_best, best_train, best_val, best_test), flush=True)
