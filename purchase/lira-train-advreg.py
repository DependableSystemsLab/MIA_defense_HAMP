...
tr_frac=0.45 # we use 50% of private data as the members to train MIA model
val_frac=0.05 # we use 25% of private data as the members to validate MIA model
te_frac=0.5 # we use 25% of private data as the members to test MIA model
