...
org_model_checkpoint_dir='./final-selena-trainSize-{}'.format( str(  args.train_size ) )
...
sub_model_indices_file_prefix = './purchase_selena_submodel_indices_%s'%str(args.train_size)
non_model_indices_file = './purchase_selena_non_model_indices_for_each_sample_%s.pkl'%str(args.train_size)
...
BATCH_SIZE=32
distil_model=PurchaseClassifier().to(device)
