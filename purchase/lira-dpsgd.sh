...
do
    python lira-train-dpsgd.py --train_size $train_size   --lr 0.005  \
    --dp_batchsize 128 --dp_noise_multiplier 1.7 --epochs 200 --save_tag $tag --total_models $total_models \
    --folder_tag $folder_tag  --dp_norm_clip 1.0 --res_folder $res_folder
